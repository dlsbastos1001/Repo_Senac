...
VALUES(
'2025-09-15', 'Notebook Dell Inspiron', 'Infprmatica', 3500, 1, 'João Silva', 'Rio de Janeiro', 'RJ');
...
'''
# having, where e groupby cai em selação
SELECT cliente,
...
SELECT categoria,
SUM(quantidade *  valor_unitario) AS media_vandida
FROM venda
GROUP BY categoria;
...
GROUP BY cliente
HAVING total_cliente > 5000 AND total_cliente < 1500000;
...
SELECT  produto, valor_unitario, cidade
FROM venda
...
SUM(quantidade *  valor_unitario) AS total_cliente
FROM venda
WHERE categoria in ('Informática', 'Acessórios', 'Eletrônicos')
GROUP BY categoria;
...
SUM(quantidade *  valor_unitario) AS total_cliente
FROM venda
WHERE total_cliente > 5000;



# 2.1 Quantas compras cada cliente realizou. Considere apenas vendas com valor unitário acima de R$200.
SELECT cliente
FROM vendas
WHERE valor_vendas, quantidade
GROUP BY clientes
HAVING valor_unitario > 200;
...
INSERT INTO pedidos (id_pedido, cliente_id) VALUES
(1, 5),
(2, 3),
(3, 4),
(4, 2),
...
INSERT INTO produto(produto_id, produto, categoria, valor_unitario) VALUES
(01, 'vaso', 'a', '50'),
(02, 'prato', 'b', '40'),
(03, 'cama', 'a', '70'),
(04, 'janela', 'b', '80'),
...
SELECT cliente.nome, pedidos.id AS crimes
FROM cliente
